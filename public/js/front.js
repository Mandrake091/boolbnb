...
/* harmony default export */ __webpack_exports__["default"] = (_name$components$data = {
  ...
  data: function data() {
    return {
      ...
      cityAddress: "",
      // posts: [],
      searchApi: "https://api.tomtom.com/search/2/autocomplete/via-cruillas.json?key=HnmOys7lX8qXGsZCcgH6WXEgs8UWaSAh&language=it-IT&limit=10&lat=&lon=&radius=20&countrySet=IT&resultSet=",
      searchBoxHTML: ""
    };
  },
  ...
  computed: {
    filteredHomeList: function filteredHomeList() {
      var _this = this;
      ...
      return this.albumList.filter(function (item) {
        return item.author === _this.searchText || item.genre === _this.searchText;
      });
    }
  }
}, _defineProperty(_name$components$data, "mounted", function mounted() {// axios
  //     .get("/api/houses/")
  //     .then((res) => {
  ...
  axios.get("/api/houses/").then(function (res) {
    res.data.forEach(function (el) {
      _this2.cities.push(el.city.charAt(0).toUpperCase() + el.city.slice(1));
    });
...
var render = function render() {
  ...
  return _c("header", [_c("nav", [_c("div", {
    staticClass: "logo"
  }, [_vm._v("Boolbnb")]), _vm._v(" "), _c("ul", _vm._l(_vm.menuItem, function (item, index) {
    return _c("li", {
      key: index,
      "class": {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }, [_vm._v("ciao")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.cityAddress,
      expression: "cityAddress"
    }],
    attrs: {
      type: "text",
    ...
    on: {
      change: _vm.findGeocoding,
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.cityAddress = $event.target.value;
      }
    }
  }), _vm._v(" "), _c("button", {
  ...
  }, [_vm._v("Città")]), _vm._v(" "), _vm._l(_vm.cities, function (city, index) {
    return _c("option", {
      key: index,
      domProps: {
        value: city
  ...
  }, [_vm._v("Filter by Genre")]), _vm._v(" "), _vm._l(_vm.cities, function (city, index) {
    return _c("option", {
      key: index,
      domProps: {
        value: city
...
/* harmony import */ var _pages_AdvancedSearchComponent_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/AdvancedSearchComponent.vue */ "./resources/js/pages/AdvancedSearchComponent.vue");
/* harmony import */ var _pages_ApartmentComponent_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/ApartmentComponent.vue */ "./resources/js/pages/ApartmentComponent.vue");
/* harmony import */ var _pages_SuccessSendComponent_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/SuccessSendComponent.vue */ "./resources/js/pages/SuccessSendComponent.vue");
/* harmony import */ var _pages_NotFoundComponent_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/NotFoundComponent.vue */ "./resources/js/pages/NotFoundComponent.vue");
/* harmony import */ var _pages_SingleHouseComponent_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/SingleHouseComponent.vue */ "./resources/js/pages/SingleHouseComponent.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: "/message",
    name: "message",
    component: _pages_SuccessSendComponent_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  }, {
    path: "/house/:slug",
    name: "single-house",
    component: _pages_SingleHouseComponent_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  }, // {
