                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row justify-content-center mb-0 pb-2">
                                <div class="col-md-8">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror p-4 mp-color"
                                ...
                                <div class="col-md-8">
                                    <div>
                                        ...
                                        @if (Route::has('password.request'))
                                            <a class="btn btn-link text-secondary px-0"
                                    ...
                                    <input id="password" type="password"
                                        class="form-control @error('password') is-invalid @enderror p-4 mp-color"
                            ...
                            <div class="form-group row mb-0 justify-content-center pb-5">
                                <div class="col-5 col-md-4">
                                    <a href="https://www.facebook.com/" class="text-white"><button type="submit"
                                            class="btn btn-primary py-3 col-12 shadow">Facebook</button></a>
                                </div>
                                <div class="col-5 col-md-4">
                                    <a href="https://accounts.google.com/signin/v2/identifier?flowName=GlifWebSignIn&flowEntry=ServiceLogin"
                                        class="text-dark"><button type="submit"
                                            class="btn btn-trasparent py-3 col-12 shadow">Google</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
