...
<form action="{{route('admin.houses.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            @foreach ($services as $service)
                <div class="form-check form-check-inline">
                    <input type="checkbox" class="form-check-input" {{in_array($service->id, old("services", [])) ? 'checked' : ''}} id="{{$service->name}}" name="services[]" value="{{$service->id}}">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('night_price') is-invalid @enderror" id="night_price" name="night_price" value="{{old('night_price')}}" placeholder="Inserisci prezzo per notte" required>
      @error('night_price')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('n_room') is-invalid @enderror" id="n_room" name="n_room" value="{{old('n_room')}}" placeholder="Inserisci numero di stanze" required>
      @error('n_room')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('n_bed') is-invalid @enderror" id="n_bed" name="n_bed" value="{{old('n_bed')}}" placeholder="Inserisci numero di posti letto" required>
      @error('n_bed')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('n_bathroom') is-invalid @enderror" id="n_bathroom" name="n_bathroom" value="{{old('n_bathroom')}}" placeholder="Inserisci numero di bagni" required>
      @error('n_bathroom')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('square_meters') is-invalid @enderror" id="square_meters" name="square_meters" value="{{old('square_meters')}}" placeholder="Inserisci numero di metri quadrati" required>
      @error('square_meters')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{old('latitude')}}" placeholder="Inserisci numero di bagni" required>
      @error('latitude')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="number" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{old('longitude')}}" placeholder="Inserisci numero di bagni" required>
      @error('longitude')
        <div class="alert alert-danger">{{ $message }}</div>
      @enderror
    </div>
