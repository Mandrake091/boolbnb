                            ...
                            <div class="form-group">
                                ...
                                <select name="type_id" id="type"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            class="form-control @error('check_out') is-invalid @enderror" id="check_out"
                                    ...
                                    <div>
                                        <p class="text-secondary d-flex justify-content-end px-3">*Tutti i campi
                                            contrassegnati con l'asterisco sono obbligatori</p>
                                    </div>
