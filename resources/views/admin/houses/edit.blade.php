...
@section('content')
    <div class="container">
        ...
        <form enctype="multipart/form-data" action="{{ route('admin.houses.update', $house->id) }}" method="post"
            ...
            <div class="form-group">
                @if ($house->image)
                    <img id="uploadPreview" width="100" src="{{ asset("storage/{$house->image}") }}"
                        alt="{{ $house->title }}">
                @endif
                {{-- manca else --}}
            ...
            <div class="form-group">
                ...
                @foreach ($services as $service)
                    <div class="form-check form-check-inline ">
                        @if (old('service'))
                            <input type="checkbox"
                                class="my-checkbox form-check-input @error('services') is-invalid @enderror"
                                id="{{ $service->slug }}" name="tags[]" value="{{ $service->id }}"
                                {{ in_array($service->id, old('service', [])) ? 'checked' : '' }}>
                        @else
                            <input type="checkbox" class="my-checkbox form-check-input" id="{{ $service->slug }}"
    ...
    @enderror
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <input type="checkbox" class="form-check-input"
                        {{ old('visibility', $house->visibility) ? 'checked' : '' }} id="visibility" name="visibility">
                    <label class="form-check-label" for="visibility">Visibile</label>
                    @error('visibility')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="form-group">
                ...
                <input min="1" type="number" class="form-control @error('night_price') is-invalid @enderror"
                    id="night_price" name="night_price" value="{{ old('night_price', $house->night_price) }}"
            ...
            <div class="form-group">
                ...
                <input min="1" type="number" class="form-control @error('n_room') is-invalid @enderror"
                    id="n_room" name="n_room" value="{{ old('n_room', $house->n_room) }}"
            ...
            <div class="form-group">
                ...
                <input min="1" type="number" class="form-control @error('n_bed') is-invalid @enderror"
                    id="n_bed" name="n_bed" value="{{ old('n_bed', $house->n_bed) }}"
            ...
            <div class="form-group">
                ...
                <input min="1" type="number" class="form-control @error('n_bathroom') is-invalid @enderror"
                    id="n_bathroom" name="n_bathroom" value="{{ old('n_bathroom', $house->n_bathroom) }}"
            ...
            <div class="form-group">
                ...
                <input min="1" type="number" class="form-control @error('square_meters') is-invalid @enderror"
                    id="square_meters" name="square_meters" value="{{ old('square_meters', $house->square_meters) }}"
    ...
    <div class="form-group">
        ...
        @enderror
            ...
            <div>
                <p class="text-secondary d-flex justify-content-end px-3">*Tutti i campi contrassegnati con l'asterisco
                    sono obbligatori</p>
            </div>
