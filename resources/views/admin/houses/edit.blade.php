...
<form enctype="multipart/form-data" action="{{ route('admin.houses.update', $house->id) }}" method="post" id="sectionForm">
    ...
    <div class="form-group">
        ...
        <div class="form-check form-check-inline ">
            @if (old('service'))
            <input type="checkbox" class="my-checkbox form-check-input @error('services') is-invalid @enderror" id="{{ $service->slug }}" name="tags[]" value="{{ $service->id }}" {{ in_array($service->id, old('service', [])) ? 'checked' : '' }}>
            @else
            <input type="checkbox" class="my-checkbox form-check-input" id="{{ $service->slug }}" name="services[]" value="{{ $service->id }}" {{ $house->services->contains($service) ? 'checked' : '' }}>
            @endif
    ...
    <div class="form-group">
        ...
        <input min="1" type="number" class="form-control @error('night_price') is-invalid @enderror" id="night_price" name="night_price" value="{{ old('night_price', $house->night_price) }}" placeholder="Inserisci prezzo per notte" required>
        @error('night_price')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input min="1" type="number" class="form-control @error('n_room') is-invalid @enderror" id="n_room" name="n_room" value="{{ old('n_room', $house->n_room) }}" placeholder="Inserisci numero di stanze" required>
        @error('n_room')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input min="1" type="number" class="form-control @error('n_bed') is-invalid @enderror" id="n_bed" name="n_bed" value="{{ old('n_bed', $house->n_bed) }}" placeholder="Inserisci numero di posti letto" required>
        @error('n_bed')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input min="1" type="number" class="form-control @error('n_bathroom') is-invalid @enderror" id="n_bathroom" name="n_bathroom" value="{{ old('n_bathroom', $house->n_bathroom) }}" placeholder="Inserisci numero di bagni" required>
        @error('n_bathroom')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input min="1" type="number" class="form-control @error('square_meters') is-invalid @enderror" id="square_meters" name="square_meters" value="{{ old('square_meters', $house->square_meters) }}" placeholder="Inserisci numero di metri quadrati" required>
        @error('square_meters')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" value="{{ old('city', $house->city) }}" placeholder="Inserisci titolo" required>
        @error('city')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $house->address) }}" placeholder="Inserisci titolo" required>
        @error('address')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div> --}}
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control @error('check_out') is-invalid @enderror" id="check_out" name="check_out" value="{{ old('check_out', $house->check_out) }}" placeholder="Inserisci numero di bagni" required>
        @error('check_out')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
